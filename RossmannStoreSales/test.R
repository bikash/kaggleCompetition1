...
train <- read.csv("data/train.csv",stringsAsFactors = F,header = T)
test <- read.csv("data/test.csv",stringsAsFactors = F,header = T)
store <- read.csv("data/store.csv",stringsAsFactors = F,header = T)
...
write_csv(submission, "output/rf1.csv")
