...
#print('Train score is:', eval_wrapper(train_preds, target)) 
#print(log_loss(trainlabels, np.clip(train_preds[:,1]*1.0088, 1e-6, 1-1e-6)))
#print('Predict...')
...
#                           'Pred': np.clip(test_preds[:,1]*1.0088, 1e-6, 1-1e-6)})
...
extc = ExtraTreesClassifier(n_estimators=2200,max_features= 29,criterion= 'entropy',min_samples_split= 1,
